...
$user_tb_nicname = $_POST['user_tb_nicname'];
        ...
        $sql = "SELECT * FROM join_room_tb LEFT JOIN room_tb ON join_room_tb.room_id = room_tb.id WHERE (user_nickname = $user_tb_nicname AND meeting_result = 1 AND user_evaluation = 0) OR (user_nickname = $user_tb_nicname AND meeting_result = 1 AND review_result = 0) ORDER BY appointment_day DESC, appointment_time DESC";
