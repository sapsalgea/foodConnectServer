...
//댓글 개수
$query = "SELECT COUNT(*) FROM review_comment WHERE review_id = $review_id AND deleteCheck = 0";
...
$sql = "SELECT * FROM review_tb LEFT JOIN user_tb ON review_tb.writer_user_tb_id = user_tb.id WHERE review_tb.review_id = $review_id";
