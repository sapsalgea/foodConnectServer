...
$clicked_user_tb_id = $_POST['clicked_user_tb_id'];
$my_user_tb_id = $_POST['my_user_tb_id'];



$sql = "SELECT * FROM review_tb LEFT JOIN user_tb ON review_tb.writer_user_tb_id = user_tb.id WHERE writer_user_tb_id = $clicked_user_tb_id AND review_deleted = 0 order by review_id DESC";
        ...
        while($row = $result->fetch_assoc()){
          ...
          $sql = "SELECT * FROM review_like_clicked_user WHERE review_tb_id = '$review_id_text' AND user_tb_id = '$my_user_tb_id'";
