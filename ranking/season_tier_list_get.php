...
if($what_tier =="스톤"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  200 >season_point  AND season_point >= 0  ORDER BY number limit 50";
}else if($what_tier =="브론즈"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  600 >season_point  AND season_point >= 200  ORDER BY number limit 50";
}else if($what_tier =="실버"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  1200 >season_point  AND season_point >= 600  ORDER BY number limit 50";
}else if($what_tier =="골드"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  2000 >season_point  AND season_point >= 1200  ORDER BY number limit 50";
}else if($what_tier =="플래티넘"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  season_point >= 2000 AND NUMBER > $diamond  ORDER BY number limit 50";
}else if($what_tier =="다이아몬드"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  season_point >= 3000 AND  NUMBER > $master AND  $diamond >= NUMBER ORDER BY number limit 50";
}else if($what_tier =="마스터"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  season_point >= 3000 AND  NUMBER > $challenger AND  $master >= NUMBER ORDER BY number limit 50";
}else if($what_tier =="챌린저"){
  $sql = "SELECT * FROM (SELECT *,(@rownum:=@rownum+1) AS number, (SELECT COUNT( * ) +1 FROM ranking_season_tb WHERE  season_point > t.season_point) AS rank  FROM ranking_season_tb  AS t   ORDER BY season_point DESC) AS k WHERE  season_point >= 3000 AND  $challenger >= NUMBER ORDER BY number limit 50";
}
